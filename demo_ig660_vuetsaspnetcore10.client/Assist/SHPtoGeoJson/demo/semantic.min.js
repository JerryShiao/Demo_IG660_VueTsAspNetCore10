        ...
        e.fn.dropdown = function (o) {
            ...
            return r.each(function () {
                var p, v, h, b, y = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.dropdown.settings, o) : e.extend({}, e.fn.dropdown.settings),
                    ...
                    F = P.find(k.search),
                    R = P.find(k.input),
                    D = P.prev().find(k.text).length > 0 ? P.prev().find(k.text) : P.prev(),
                    O = P.children(k.menu),
                    z = O.find(k.item),
                    q = !1,
                    j = !1,
                ...
                b = {
                    initialize: function () {
                        b.debug("Initializing dropdown", y), b.is.alreadySetup() ? b.error(T.alreadySetup) : b.setup.layout(), b.save.defaults(), b.set.selected(), b.create.id(), l && b.bind.touchEvents(), b.bind.mouseEvents(), b.bind.keyboardEvents(), b.observeChanges(), b.instantiate()
                    },
                    instantiate: function () {
                    ...
                    setup: {
                        ...
                        select: function () {
                            ...
                            b.debug("Dropdown initialized on a select", t), P.is("select") && (R = P), R.parent(k.dropdown).length > 0 ? (b.debug("UI dropdown already exists. Creating dropdown menu only"), P = R.closest(k.dropdown), O = P.children(k.menu), 0 === O.length && (O = e("<div />").addClass(x.menu).appendTo(P)), O.html(y.templates.menu(t))) : (b.debug("Creating entire dropdown from select"), P = e("<div />").attr("class", R.attr("class")).addClass(x.selection).addClass(x.dropdown).html(y.templates.dropdown(t)).insertBefore(R), R.removeAttr("class").prependTo(P)), b.refresh()
                        }
                    },
                    refresh: function () {
                        b.verbose("Refreshing selector cache"), E = P.find(k.text), F = P.find(k.search), R = P.find(k.input), D = P.prev().find(k.text).length > 0 ? P.prev().find(k.text) : P.prev(), O = P.children(k.menu), z = O.find(k.item)
                    },
                    toggle: function () {
        ...
        e.fn.modal = function (o) {
            ...
            return r.each(function () {
                ...
                T = {
                    ...
                    instantiate: function () {
                        T.verbose("Storing instance of modal"), N = T, O.data(D, N)
                    },
                    create: {
                        dimmer: function () {
                            var t = {
                            ...
                            return e.fn.dimmer === i ? void T.error(F.dimmer) : (T.debug("Creating dimmer with settings", n), y = z.dimmer(n), S.detachable && (T.verbose("Modal is detachable, moving content into dimmer"), y.dimmer("add content", O)), void (x = y.dimmer("get dimmer")))
                        },
                        id: function () {
                            T.verbose("Creating unique id for element"), C = T.get.uniqueID(), w = "." + C
                        }
                    },
                    destroy: function () {
                        T.verbose("Destroying previous modal"), O.removeData(D).off(R), s.off(w), q.off(R), z.dimmer("destroy")
                    },
                    observeChanges: function () {
                    ...
                    event: {
                        ...
                        click: function (t) {
                            0 === e(t.target).closest(O).length && (T.debug("Dimmer clicked, hiding all modals"), T.is.active() && (T.remove.clickaway(), S.allowMultiple ? T.hide() : T.hideAll()))
                        },
                    ...
                    showModal: function (t) {
                        t = e.isFunction(t) ? t : function () { }, T.is.animating() || !T.is.active() ? (T.showDimmer(), T.cacheSizes(), T.set.position(), T.set.screenHeight(), T.set.type(), T.set.clickaway(), !S.allowMultiple && h.filter(":visible").length > 0 ? (T.debug("Other modals visible, queueing show animation"), T.hideOthers(T.showModal)) : (S.onShow.call(j), S.transition && e.fn.transition !== i && O.transition("is supported") ? (T.debug("Showing modal with css animations"), O.transition({
                            debug: S.debug,
                        ...
                        })) : (T.debug("Showing modal with javascript"), O.fadeIn(S.duration, S.easing, function () {
                            S.onVisible.apply(j), T.add.keyboardShortcuts(), T.save.focus(), T.set.active(), t()
                        })))) : T.debug("Modal is already visible")
                    },
                    hideModal: function (t) {
                        t = e.isFunction(t) ? t : function () { }, T.debug("Hiding modal"), S.onHide.call(j), (T.is.animating() || T.is.active()) && (S.transition && e.fn.transition !== i && O.transition("is supported") ? (T.remove.active(), O.transition({
                            debug: S.debug,
                            ...
                            useFailSafe: !0,
                            onStart: function () {
                                T.othersActive() || T.hideDimmer(), T.remove.keyboardShortcuts()
                            },
                            onComplete: function () {
                                S.onHidden.call(j), T.restore.focus(), t()
                            }
                        })) : (T.remove.active(), T.othersActive() || T.hideDimmer(), T.remove.keyboardShortcuts(), O.fadeOut(S.duration, S.easing, function () {
                            S.onHidden.call(j), T.restore.focus(), t()
                        })))
                    },
                    showDimmer: function () {
                    ...
                    hideDimmer: function () {
                        return y.dimmer("is animating") || y.dimmer("is active") ? void y.dimmer("hide", function () {
                            S.transition && e.fn.transition !== i && O.transition("is supported") && (T.remove.clickaway(), T.remove.screenHeight())
                        }) : void T.debug("Dimmer is not visible cannot hide")
                    },
                    hideAll: function (t) {
                        t = e.isFunction(t) ? t : function () { }, r.is(":visible") && (T.debug("Hiding all visible modals"), T.hideDimmer(), r.filter(":visible").modal("hide modal", t))
                    },
                    hideOthers: function (t) {
                        t = e.isFunction(t) ? t : function () { }, h.is(":visible") && (T.debug("Hiding other modals", h), h.filter(":visible").modal("hide modal", t))
                    },
                    ...
                    set: {
                        ...
                        position: function () {
                            T.verbose("Centering modal on page", T.cache), O.css(T.can.fit() ? {
                                top: "",
    ...
    function (e, t, n, i) {
        ...
        e.fn.popup = function (o) {
            ...
            return r.each(function () {
                ...
                g = {
                    initialize: function () {
                        g.debug("Initializing module", k), "click" == p.on ? k.on("click" + w, g.toggle) : g.get.startEvent() && k.on(g.get.startEvent() + w, g.event.start).on(g.get.endEvent() + w, g.event.end), p.target && g.debug("Target set to element", S), A.on("resize" + w, g.event.resize), !g.exists() && p.preserve && g.create(), g.instantiate()
                    },
                    instantiate: function () {
                        g.verbose("Storing instance of module", g), D = g, k.data(C, D)
                    },
                    refresh: function () {
                    ...
                    destroy: function () {
                        g.debug("Destroying previous module"), n && !p.preserve && g.removePopup(), clearTimeout(g.hideTimer), clearTimeout(g.showTimer), k.off(w).removeData(C)
                    },
                    event: {
                        start: function () {
                    ...
                    create: function () {
                        var t = k.data(y.html) || p.html,
                            i = k.data(y.variation) || p.variation,
                            o = k.data(y.title) || p.title,
                            a = k.data(y.content) || k.attr("title") || p.content;
                    ...
                    exists: function () {
                        return n ? p.inline || p.popup ? g.has.popup() : n.closest(T).length >= 1 ? !0 : !1 : !1
                    },
                    ...
                    save: {
                        conditions: function () {
                            g.cache = {
                                title: k.attr("title")
                            }, g.cache.title && k.removeAttr("title"), g.verbose("Saving original attributes", g.cache.title)
                        }
                    },
                    restore: {
                        conditions: function () {
                            return g.cache && g.cache.title && (k.attr("title", g.cache.title), g.verbose("Restoring original attributes", g.cache.title)), !0
                        }
                    },
                    animate: {
                        show: function (t) {
                            t = e.isFunction(t) ? t : function () { }, p.transition && e.fn.transition !== i && k.transition("is supported") ? (g.set.visible(), n.transition({
                        ...
                        hide: function (t) {
                            t = e.isFunction(t) ? t : function () { }, g.debug("Hiding pop-up"), p.transition && e.fn.transition !== i && k.transition("is supported") ? n.transition({
                    ...
                    set: {
                        position: function (o, a) {
                            var s, c, l, u = (e(t).width(), e(t).height(), S.outerWidth()),
                                ...
                                w = p.distanceAway,
                                C = S[0],
                                T = p.inline ? parseInt(t.getComputedStyle(C).getPropertyValue("margin-top"), 10) : 0,
                            ...
                            switch (o = o || k.data(y.position) || p.position, a = a || k.data(y.offset) || p.offset, E == p.maxSearchDepth && p.lastResort && (g.debug("Using last resort position to display", p.lastResort), o = p.lastResort), p.inline && (g.debug("Adding targets margin to calculation"), "left center" == o || "right center" == o ? (a += T, w += -A) : "top left" == o || "top center" == o || "top right" == o ? (a += A, w -= T) : (a += A, w += T)), g.debug("Calculating popup positioning", o), s = o, g.is.rtl() && (s = s.replace(/left|right/g, function (e) {
                    ...
                    bind: {
                        ...
                        close: function () {
                            (p.hideOnScroll === !0 || "auto" == p.hideOnScroll && "click" != p.on) && (s.one("touchmove" + w, g.hideGracefully).one("scroll" + w, g.hideGracefully), T.one("touchmove" + w, g.hideGracefully).one("scroll" + w, g.hideGracefully)), "click" == p.on && p.closable && (g.verbose("Binding popup close event to document"), s.on("click" + w, function (e) {
                    ...
                    unbind: {
                        close: function () {
                            (p.hideOnScroll === !0 || "auto" == p.hideOnScroll && "click" != p.on) && (s.off("scroll" + w, g.hide), T.off("scroll" + w, g.hide)), "click" == p.on && p.closable && (g.verbose("Removing close event from document"), s.off("click" + w))
                        }
                    },
                    has: {
                        popup: function () {
                    ...
                    is: {
                        ...
                        dropdown: function () {
                            return k.hasClass(h.dropdown)
                        },
                        hidden: function () {
                            return !g.is.visible()
                        },
                        rtl: function () {
                            return "rtl" == k.css("direction")
                        }
                    },
                    reset: function () {
                ...
                }, f ? (D === i && g.initialize(), g.invoke(d)) : (D !== i && D.invoke("destroy"), g.initialize())
            }), a !== i ? a : this
        }, e.fn.popup.settings = {
            name: "Popup",
            debug: !1,
            ...
            return e(this).each(function () {
                ...
                m = {
                    initialize: function () {
                        ...
                        g.automatic && T.on(t + w, m.throttle), T.on("focus" + w, m.event.focus).on("blur" + w, m.event.blur).on("keydown" + w, m.handleKeyboard), S.on("click" + w, m.query), A.on("mousedown" + w, m.event.result.mousedown).on("mouseup" + w, m.event.result.mouseup).on("click" + w, b.result, m.event.result.click), m.instantiate()
                    },
                    instantiate: function () {
                    ...
                    get: {
                        ...
                        result: function (t, n) {
                            ...
                            return t = t || m.get.value(), n = n || m.get.results(), "category" === g.type ? (m.debug("Finding result that matches", t), e.each(n, function (n, o) {
                                return e.isArray(o.results) && (i = m.search.object(t, o.results)[0], i.length > 0) ? !0 : void 0
        ...
        e.fn.sidebar = function (o) {
            ...
            return r.each(function () {
                var r, b, y, x, w, C, k = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.sidebar.settings, o) : e.extend({}, e.fn.sidebar.settings),
                    ...
                    D = e(this),
                    O = e(k.context),
                    z = D.children(T.sidebar),
                    q = O.children(T.fixed),
                    j = O.children(T.pusher),
                    N = this,
                    I = D.data(R);
                C = {
                    initialize: function () {
                    ...
                    bind: {
                        ...
                        scrollLock: function () {
                            k.scrollLock && (C.debug("Disabling page scroll"), s.on("DOMMouseScroll" + b, C.event.scroll)), C.verbose("Adding events to contain sidebar scroll"), c.on("touchmove" + b, C.event.touch), D.on("scroll" + F, C.event.containScroll)
                        }
                    },
                    unbind: {
                        clickaway: function () {
                    ...
                    refresh: function () {
                        C.verbose("Refreshing selector cache"), O = e(k.context), z = O.children(T.sidebar), j = O.children(T.pusher), q = O.children(T.fixed)
                    },
                    refreshSidebars: function () {
                        C.verbose("Refreshing other sidebars"), z = O.children(T.sidebar)
                    },
                    repaint: function () {
                    ...
                    setup: {
                        layout: function () {
                            0 === O.children(T.pusher).length && (C.debug("Adding wrapper element for sidebar"), C.error(E.pusher), j = e('<div class="pusher" />'), O.children().not(T.omitted).not(z).wrapAll(j), C.refresh()), (0 === D.nextAll(T.pusher).length || D.nextAll(T.pusher)[0] !== j[0]) && (C.debug("Moved sidebar to correct parent element"), C.error(E.movedSidebar, N), D.detach().prependTo(O), C.refresh()), C.set.pushable(), C.set.direction()
                        }
                    },
                    attachEvents: function (t, n) {
                        var i = e(t);
                    ...
                    legacyPushPage: function (t) {
                        var n = D.width(),
                            i = C.get.direction(),
                            o = {};
                        n = n || D.width(), t = e.isFunction(t) ? t : function () { }, o[i] = n, C.debug("Using javascript to push context", o), C.set.visible(), C.set.transition(), C.set.animating(), k.dimPage && j.addClass(S.dimmed), O.css("position", "relative").animate(o, k.duration, k.easing, function () {
                    ...
                    legacyPullPage: function (t) {
                        var n = 0,
                            i = C.get.direction(),
                            o = {};
                        n = n || D.width(), t = e.isFunction(t) ? t : function () { }, o[i] = "0px", C.debug("Using javascript to pull context", o), C.unbind.clickaway(), C.set.animating(), C.remove.visible(), k.dimPage && !C.othersActive() && j.removeClass(S.dimmed), O.css("position", "relative").animate(o, k.duration, k.easing, function () {
                ...
                m = {
                    ...
                    set: {
                        ...
                        containerSize: function () {
                            ...
                            "HTML" === e || "body" == e ? C = x.offsetParent() : (m.debug("Settings container size", m.cache.context.height), Math.abs(C.height() - m.cache.context.height) > 5 && C.height(m.cache.context.height))
                        },
                        scroll: function (e) {
        ...
        e.fn.transition = function () {
            ...
            return a.each(function (t) {
                ...
                k = {
                    ...
                    restore: {
                        conditions: function () {
                            return k.cache === i ? !1 : (k.cache.className ? T.attr("class", k.cache.className) : T.removeAttr("class"), k.cache.style && (k.verbose("Restoring original style attribute", k.cache.style), console.log("restoring cache", k.cache.style), T.attr("style", k.cache.style)), k.is.looping() && k.remove.looping(), void k.verbose("Restoring original attributes", k.cache))
                        }
                    },
                    add: {
                        failSafe: function () {
                    ...
                    remove: {
                        ...
                        looping: function () {
                            k.debug("Transitions are no longer looping"), T.removeClass(v.looping), k.forceRepaint()
                        },
                        transition: function () {
                    ...
                    can: {
                        transition: function (t) {
                            ...
                            if (d === i || t) {
                                ...
                                k.save.displayType(s), k.save.transitionExists(u, r)
                            }
                            return d !== i ? d : r
                        },
                        animate: function () {
                    ...
                    show: function (e) {
                        k.verbose("Showing element", e), k.remove.hidden(), k.set.visible(), k.repaint()
                    },
                    start: function () {
                    ...
                    toggle: function () {
                        k.debug("Toggling play status"), T.toggleClass(v.disabled)
                    },
                    setting: function (t, n) {
                    ...
                    performance: {
                        log: function (e) {
                            ...
                            m.performance && (t = (new Date).getTime(), i = s || t, n = t - i, s = t, c.push({
                                ...
                                Element: S,
                                "Execution Time": n
                            })), clearTimeout(k.performance.timer), k.performance.timer = setTimeout(k.performance.display, 600)
                        },
                        display: function () {
                            var t = m.name + ":",
                                n = 0;
                ...
                g = {
                    ...
                    query: function () {
                        ...
                        if (g.cancelled = !1, p.url ? (g.debug("Using specified url", f), f = g.add.urlData(p.url)) : (f = g.add.urlData(g.get.templateURL()), g.debug("Added URL Data to url", f)), !f) {
                            if (!k.is("form")) return void g.error(y.missingURL, p.action);
                            g.debug("No url or action specified, defaulting to form action"), f = k.attr("action")
                        }
                    ...
                    get: {
                        ...
                        defaultData: function () {
                            var t = {};
                            return e.isWindow(A) || (k.is("input") ? t.value = k.val() : k.is("form") || (t.text = k.text())), t
                        },
                        event: function () {
                        ...
                        formData: function () {
                            var t;
                            return e(this).serializeObject() !== i ? t = T.serializeObject() : (g.error(y.missingSerialize), t = T.serialize()), g.debug("Retrieved form data", t), t
                        },
                        templateURL: function (e) {
                            var t;
                            return e = e || k.data(h.action) || p.action || !1, e && (g.debug("Looking up url for action", e, p.api), p.api[e] !== i ? (t = p.api[e], g.debug("Found template url", t)) : g.error(y.missingAction, p.action, p.api)), t
                        }
                    },
                    abort: function () {
                        var e = g.get.xhr();
            ...
            return r.each(function () {
                ...
                r = {
                    ...
                    event: {
                        ...
                        scroll: function () {
                            r.verbose("Scroll position changed"), m.throttle ? (clearTimeout(r.timer), r.timer = setTimeout(r.checkVisibility, m.throttle)) : k(r.checkVisibility)
                        }
                    },
                    ...
                    refresh: function () {
                        r.debug("Refreshing constants (element width/height)"), r.reset(), r.save.position(), r.checkVisibility(), m.onRefresh.call(T)
                    },
                    reset: function () {
                    ...
                    execute: function (e, t) {
                        ...
                        e = e || !1, e && (m.continuous ? (r.debug("Callback being called continuously", t, n), e.call(T, n, i)) : r.get.occurred(t) || (r.debug("Conditions met", t, n), e.call(T, n, i))), r.save.occurred(t)
                    },
                    remove: {
                        occurred: function (e) {
                    ...
                    invoke: function (t, n, o) {
                        var s, c, l, u = C;
                        return n = n || f, o = T || o, "string" == typeof t && u !== i && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function (n, o) {
                ...
                }, d ? (C === i && r.initialize(), r.invoke(u)) : (C !== i && C.invoke("destroy"), r.initialize())
            }), a !== i ? a : this
