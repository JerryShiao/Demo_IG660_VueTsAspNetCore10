    ...
    init: function (options) {
      ...
      $.when($.get(csv_path)).then(
        function(data){      
          ...
          if (allow_download)
              //$("#" + el).append("<p><a class='btn btn-info' onclick='parent.logbt3List(csv_data);'><i class='glyphicon glyphicon-download'></i>於地圖展示</a></p>");
              $("#" + el).append("<p><a class='btn btn-info' href='" + csv_path + "'><i class='glyphicon glyphicon-download'></i>下載此表格</a></p>");
        });
    }
}
