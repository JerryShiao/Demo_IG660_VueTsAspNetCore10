...
//附繳文件額外項目
let moredoc = document.getElementById("moredoc");

moredoc.addEventListener("change", () => {
    if (moredoc.checked) {
        let expinfo = document.getElementById("expinfo");
